...
public class BlockFenceGate extends BlockHorizontal {
    ...
    public BlockFenceGate(Material material)
    {
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
    {
        ...
        if (enumfacing$axis == EnumFacing.Axis.Z && (worldIn.getBlockState(pos.west()).getBlock() instanceof net.minecraft.block.BlockWall || worldIn.getBlockState(pos.east()).getBlock() instanceof net.minecraft.block.BlockWall) || enumfacing$axis == EnumFacing.Axis.X && (worldIn.getBlockState(pos.north()).getBlock() instanceof net.minecraft.block.BlockWall || worldIn.getBlockState(pos.south()).getBlock() instanceof net.minecraft.block.BlockWall))
        {
    ...
    public boolean canBeConnectedTo(IBlockAccess world, BlockPos pos, EnumFacing facing)
    {
        ...
        if (state.getBlock() instanceof net.minecraft.block.BlockFenceGate &&
