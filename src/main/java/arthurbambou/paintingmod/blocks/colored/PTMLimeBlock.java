...
public class PTMLimeBlock extends Block implements PTMIHasModel
{

	public PTMLimeBlock(String name, Material material, SoundType sound, float hardness, float resistance, String harvestTool, int harvestLevel)
	{
		super(material);
		setCreativeTab(PTMMain.PAINTING_MOD);
		setTranslationKey("lime_" + name); 
	    setRegistryName("lime_" + name);
		setSoundType(sound);
