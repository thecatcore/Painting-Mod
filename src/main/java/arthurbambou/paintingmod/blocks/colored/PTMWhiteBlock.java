...
public class PTMWhiteBlock extends Block implements PTMIHasModel
{

	public PTMWhiteBlock(String name, Material material, SoundType sound, float hardness, float resistance, String harvestTool, int harvestLevel)
	{
		super(material);
		setCreativeTab(PTMMain.PAINTING_MOD);
		setTranslationKey("white_" + name); 
	    setRegistryName("white_" + name);
		setSoundType(sound);
