...
public class PTMRedBlock extends Block implements PTMIHasModel
{

	public PTMRedBlock(String name, Material material, SoundType sound, float hardness, float resistance, String harvestTool, int harvestLevel)
	{
		super(material);
		setCreativeTab(PTMMain.PAINTING_MOD);
		setTranslationKey("red_" + name); 
	    setRegistryName("red_" + name);
		setSoundType(sound);
