...
public class PTMColoredBlockMetaBase extends ColoredBlockMeta implements PTMIHasModel, PTMIMetaName {
    ...
    public PTMColoredBlockMetaBase(String name, float hardness, float resistance, Block replace) {
...
//        }
    ...
    public PTMColoredBlockMetaBase(String name, float hardness, float resistance, Block replace, int replacemeta) {
