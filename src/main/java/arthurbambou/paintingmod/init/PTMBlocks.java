...
public class PTMBlocks {
	...
	public static final ColoredBlock STONE = new ColoredBlock("stone", Material.ROCK, SoundType.STONE, 1.5F, 30.0F, "pickaxe", 1);
	public static final ColoredBlock GRANITE = new ColoredBlock("granite", Material.ROCK, SoundType.STONE, 1.5F, 30.0F, "pickaxe", 1);
	public static final ColoredBlock POLISHED_GRANITE = new ColoredBlock("polished_granite", Material.ROCK, SoundType.STONE, 1.5F, 30.0F, "pickaxe", 1);
	public static final ColoredBlock DIORITE = new ColoredBlock("diorite", Material.ROCK, SoundType.STONE, 1.5F, 30.0F, "pickaxe", 1);
	public static final ColoredBlock POLISHED_DIORITE = new ColoredBlock("polished_diorite", Material.ROCK, SoundType.STONE, 1.5F, 30.0F, "pickaxe", 1);
	public static final ColoredBlock ANDESITE = new ColoredBlock("andesite", Material.ROCK, SoundType.STONE, 1.5F, 30.0F, "pickaxe", 1);
	public static final ColoredBlock POLISHED_ANDESITE = new ColoredBlock("polished_andesite", Material.ROCK, SoundType.STONE, 1.5F, 30.0F, "pickaxe", 1);
	public static final ColoredBlock DIRT = new ColoredBlock("dirt", Material.GROUND, SoundType.GROUND, 0.5F, 2.5F, "shovel", 0);
	public static final ColoredBlock COARSE_DIRT = new ColoredBlock("coarse_dirt", Material.GROUND, SoundType.GROUND, 0.5F, 2.5F, "shovel", 0);
	public static final ColoredBlock COBBLESTONE = new ColoredBlock("cobblestone", Material.ROCK, SoundType.STONE, 2.0F, 30.0F, "pickaxe", 1);
	public static final ColoredBlock PLANK = new ColoredBlock("plank", Material.WOOD, SoundType.WOOD, 2.0F, 15.0F, "axe", 0);
	public static final ColoredBlock SAND = new ColoredBlock("sand", Material.SAND, SoundType.SAND, 0.5F, 2.5F, "shovel", 0);
	public static final ColoredBlock GRAVEL = new ColoredBlock("gravel", Material.GROUND, SoundType.GROUND, 0.6F, 3.0F, "shovel", 0);
	public static final ColoredBlock SPONGE = new ColoredBlock("sponge", Material.SPONGE, SoundType.SLIME, 0.6F, 3.0F, "null", 0);
	public static final ColoredBlock WET_SPONGE = new ColoredBlock("wet_sponge", Material.SPONGE, SoundType.SLIME, 0.6F, 3.0F, "null", 0);
	public static final ColoredBlock LAPIS_LAZULI_BLOCK = new ColoredBlock("lapis_lazuli_block", Material.IRON, SoundType.METAL, 3.0F, 15.0F, "pickaxe", 2);
	public static final ColoredBlock SANDSTONE = new ColoredBlock("sandstone", Material.GROUND, SoundType.STONE, 0.8F, 4.0F, "pickaxe", 1);
	public static final ColoredBlock GOLD_BLOCK = new ColoredBlock("gold_block", Material.IRON, SoundType.METAL, 3.0F, 30.0F, "pickaxe", 3);
	public static final ColoredBlock IRON_BLOCK = new ColoredBlock("iron_block", Material.IRON, SoundType.METAL, 5.0F, 30.0F, "pickaxe", 2);
	public static final ColoredBlock BRICK = new ColoredBlock("brick", Material.ROCK, SoundType.GROUND, 2.0F, 30.0F, "pickaxe", 1);
	public static final ColoredBlock MOSS_STONE = new ColoredBlock("moss_stone", Material.ROCK, SoundType.GROUND, 2.0F, 30.0F, "pickaxe", 1);
	public static final ColoredBlock OBSIDIAN = new ColoredBlock("obsidian", Material.ROCK, SoundType.STONE, 50.0F, 6000.0F, "pickaxe", 4);
	public static final ColoredBlock DIAMOND_BLOCK = new ColoredBlock("diamond_block", Material.IRON, SoundType.METAL, 5.0F, 30.0F, "pickaxe", 3);
	public static final ColoredBlock ICE = new ColoredBlock("ice", Material.GLASS, SoundType.GROUND, 0.5F, 2.5F, "null", 0);
	public static final ColoredBlock SNOW_BLOCK = new ColoredBlock("snow_block", Material.SNOW, SoundType.SNOW, 0.2F, 1.0F, "shovel", 1);
	public static final ColoredBlock CLAY_BLOCK = new ColoredBlock("clay_block", Material.CLAY, SoundType.GROUND, 2.0F, 30.0F, "shovel", 0);
	public static final ColoredBlock NETHERRACK = new ColoredBlock("netherrack", Material.ROCK, SoundType.STONE, 0.4F, 2.0F, "pickaxe", 1);
	public static final ColoredBlock SOUL_SAND = new ColoredBlock("soul_sand", Material.ROCK, SoundType.STONE, 0.5F, 2.5F, "shovel", 0);
	public static final ColoredBlock GLOWSTONE = new ColoredBlock("glowstone", Material.GLASS, SoundType.GLASS, 0.3F, 1.5F, "pickaxe", 0);
	public static final ColoredBlock STONE_BRICK = new ColoredBlock("stone_brick", Material.ROCK, SoundType.STONE, 1.5F, 30.0F, "pickaxe", 1);
	public static final ColoredBlock CRACKED_STONE_BRICK = new ColoredBlock("cracked_stone_brick", Material.ROCK, SoundType.STONE, 1.5F, 30.0F, "pickaxe", 1);
	public static final ColoredBlock MOSSY_STONE_BRICK = new ColoredBlock("mossy_stone_brick", Material.ROCK, SoundType.STONE, 1.5F, 30.0F, "pickaxe", 1);
	public static final ColoredBlock CHISELED_STONE_BRICK = new ColoredBlock("chiseled_stone_brick", Material.ROCK, SoundType.STONE, 1.5F, 30.0F, "pickaxe", 1);
	public static final ColoredBlock NETHER_BRICK = new ColoredBlock("nether_brick", Material.ROCK, SoundType.STONE, 2.0F, 30.0F, "pickaxe", 1);
	public static final ColoredBlock END_STONE = new ColoredBlock("end_stone", Material.ROCK, SoundType.STONE, 3.0F, 45.0F, "pickaxe", 1);
	public static final ColoredBlock EMERALD_BLOCK = new ColoredBlock("emerald_block", Material.ROCK, SoundType.STONE, 5.0F, 30.0F, "pickaxe", 3);
