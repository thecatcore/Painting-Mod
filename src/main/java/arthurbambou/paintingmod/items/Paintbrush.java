...
public class Paintbrush extends ItemBase {
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		newbloctopaint(player, worldIn, pos, Blocks.GOLD_BLOCK, ModBlocks.BLACK_GOLD_BLOCK, ModBlocks.RED_GOLD_BLOCK, ModBlocks.GREEN_GOLD_BLOCK, ModBlocks.BROWN_GOLD_BLOCK, ModBlocks.BLUE_GOLD_BLOCK, ModBlocks.PURPLE_GOLD_BLOCK, ModBlocks.CYAN_GOLD_BLOCK, ModBlocks.LIGHT_GRAY_GOLD_BLOCK, ModBlocks.GRAY_GOLD_BLOCK, ModBlocks.PINK_GOLD_BLOCK, ModBlocks.LIME_GOLD_BLOCK, ModBlocks.YELLOW_GOLD_BLOCK, ModBlocks.LIGHT_BLUE_GOLD_BLOCK, ModBlocks.MAGENTA_GOLD_BLOCK, ModBlocks.ORANGE_GOLD_BLOCK, ModBlocks.WHITE_GOLD_BLOCK);
		newbloctopaint(player, worldIn, pos, Blocks.IRON_BLOCK, ModBlocks.BLACK_IRON_BLOCK, ModBlocks.RED_IRON_BLOCK, ModBlocks.GREEN_IRON_BLOCK, ModBlocks.BROWN_IRON_BLOCK, ModBlocks.BLUE_IRON_BLOCK, ModBlocks.PURPLE_IRON_BLOCK, ModBlocks.CYAN_IRON_BLOCK, ModBlocks.LIGHT_GRAY_IRON_BLOCK, ModBlocks.GRAY_IRON_BLOCK, ModBlocks.PINK_IRON_BLOCK, ModBlocks.LIME_IRON_BLOCK, ModBlocks.YELLOW_IRON_BLOCK, ModBlocks.LIGHT_BLUE_IRON_BLOCK, ModBlocks.MAGENTA_IRON_BLOCK, ModBlocks.ORANGE_IRON_BLOCK, ModBlocks.WHITE_IRON_BLOCK);
		newbloctopaint(player, worldIn, pos, Blocks.BRICK_BLOCK, ModBlocks.BLACK_BRICK, ModBlocks.RED_BRICK, ModBlocks.GREEN_BRICK, ModBlocks.BROWN_BRICK, ModBlocks.BLUE_BRICK, ModBlocks.PURPLE_BRICK, ModBlocks.CYAN_BRICK, ModBlocks.LIGHT_GRAY_BRICK, ModBlocks.GRAY_BRICK, ModBlocks.PINK_BRICK, ModBlocks.LIME_BRICK, ModBlocks.YELLOW_BRICK, ModBlocks.LIGHT_BLUE_BRICK, ModBlocks.MAGENTA_BRICK, ModBlocks.ORANGE_BRICK, ModBlocks.WHITE_BRICK);
		newbloctopaint(player, worldIn, pos, Blocks.MOSSY_COBBLESTONE, ModBlocks.BLACK_MOSS_STONE, ModBlocks.RED_MOSS_STONE, ModBlocks.GREEN_MOSS_STONE, ModBlocks.BROWN_MOSS_STONE, ModBlocks.BLUE_MOSS_STONE, ModBlocks.PURPLE_MOSS_STONE, ModBlocks.CYAN_MOSS_STONE, ModBlocks.LIGHT_GRAY_MOSS_STONE, ModBlocks.GRAY_MOSS_STONE, ModBlocks.PINK_MOSS_STONE, ModBlocks.LIME_MOSS_STONE, ModBlocks.YELLOW_MOSS_STONE, ModBlocks.LIGHT_BLUE_MOSS_STONE, ModBlocks.MAGENTA_MOSS_STONE, ModBlocks.ORANGE_MOSS_STONE, ModBlocks.WHITE_MOSS_STONE);
		newbloctopaint(player, worldIn, pos, Blocks.OBSIDIAN, ModBlocks.BLACK_OBSIDIAN, ModBlocks.RED_OBSIDIAN, ModBlocks.GREEN_OBSIDIAN, ModBlocks.BROWN_OBSIDIAN, ModBlocks.BLUE_OBSIDIAN, ModBlocks.PURPLE_OBSIDIAN, ModBlocks.CYAN_OBSIDIAN, ModBlocks.LIGHT_GRAY_OBSIDIAN, ModBlocks.GRAY_OBSIDIAN, ModBlocks.PINK_OBSIDIAN, ModBlocks.LIME_OBSIDIAN, ModBlocks.YELLOW_OBSIDIAN, ModBlocks.LIGHT_BLUE_OBSIDIAN, ModBlocks.MAGENTA_OBSIDIAN, ModBlocks.ORANGE_OBSIDIAN, ModBlocks.WHITE_OBSIDIAN);
		newbloctopaint(player, worldIn, pos, Blocks.DIAMOND_BLOCK, ModBlocks.BLACK_DIAMOND_BLOCK, ModBlocks.RED_DIAMOND_BLOCK, ModBlocks.GREEN_DIAMOND_BLOCK, ModBlocks.BROWN_DIAMOND_BLOCK, ModBlocks.BLUE_DIAMOND_BLOCK, ModBlocks.PURPLE_DIAMOND_BLOCK, ModBlocks.CYAN_DIAMOND_BLOCK, ModBlocks.LIGHT_GRAY_DIAMOND_BLOCK, ModBlocks.GRAY_DIAMOND_BLOCK, ModBlocks.PINK_DIAMOND_BLOCK, ModBlocks.LIME_DIAMOND_BLOCK, ModBlocks.YELLOW_DIAMOND_BLOCK, ModBlocks.LIGHT_BLUE_DIAMOND_BLOCK, ModBlocks.MAGENTA_DIAMOND_BLOCK, ModBlocks.ORANGE_DIAMOND_BLOCK, ModBlocks.WHITE_DIAMOND_BLOCK);
		newbloctopaint(player, worldIn, pos, Blocks.ICE, ModBlocks.BLACK_ICE, ModBlocks.RED_ICE, ModBlocks.GREEN_ICE, ModBlocks.BROWN_ICE, ModBlocks.BLUE_ICE, ModBlocks.PURPLE_ICE, ModBlocks.CYAN_ICE, ModBlocks.LIGHT_GRAY_ICE, ModBlocks.GRAY_ICE, ModBlocks.PINK_ICE, ModBlocks.LIME_ICE, ModBlocks.YELLOW_ICE, ModBlocks.LIGHT_BLUE_ICE, ModBlocks.MAGENTA_ICE, ModBlocks.ORANGE_ICE, ModBlocks.WHITE_ICE);
		newbloctopaint(player, worldIn, pos, Blocks.CLAY, ModBlocks.BLACK_CLAY_BLOCK, ModBlocks.RED_CLAY_BLOCK, ModBlocks.GREEN_CLAY_BLOCK, ModBlocks.BROWN_CLAY_BLOCK, ModBlocks.BLUE_CLAY_BLOCK, ModBlocks.PURPLE_CLAY_BLOCK, ModBlocks.CYAN_CLAY_BLOCK, ModBlocks.LIGHT_GRAY_CLAY_BLOCK, ModBlocks.GRAY_CLAY_BLOCK, ModBlocks.PINK_CLAY_BLOCK, ModBlocks.LIME_CLAY_BLOCK, ModBlocks.YELLOW_CLAY_BLOCK, ModBlocks.LIGHT_BLUE_CLAY_BLOCK, ModBlocks.MAGENTA_CLAY_BLOCK, ModBlocks.ORANGE_CLAY_BLOCK, ModBlocks.WHITE_CLAY_BLOCK);
