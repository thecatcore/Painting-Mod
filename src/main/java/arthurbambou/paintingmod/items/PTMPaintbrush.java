...
//		newbloctopaint(player, worldIn, pos, Blocks.NETHER_BRICK, PTMBlocks.BLACK_NETHER_BRICK, PTMBlocks.RED_NETHER_BRICK, PTMBlocks.GREEN_NETHER_BRICK, PTMBlocks.BROWN_NETHER_BRICK, PTMBlocks.BLUE_NETHER_BRICK, PTMBlocks.PURPLE_NETHER_BRICK, PTMBlocks.CYAN_NETHER_BRICK, PTMBlocks.LIGHT_GRAY_NETHER_BRICK, PTMBlocks.GRAY_NETHER_BRICK, PTMBlocks.PINK_NETHER_BRICK, PTMBlocks.LIME_NETHER_BRICK, PTMBlocks.YELLOW_NETHER_BRICK, PTMBlocks.LIGHT_BLUE_NETHER_BRICK, PTMBlocks.MAGENTA_NETHER_BRICK, PTMBlocks.ORANGE_NETHER_BRICK, PTMBlocks.WHITE_NETHER_BRICK);
//		newbloctopaint(player, worldIn, pos, Blocks.END_STONE, PTMBlocks.BLACK_END_STONE, PTMBlocks.RED_END_STONE, PTMBlocks.GREEN_END_STONE, PTMBlocks.BROWN_END_STONE, PTMBlocks.BLUE_END_STONE, PTMBlocks.PURPLE_END_STONE, PTMBlocks.CYAN_END_STONE, PTMBlocks.LIGHT_GRAY_END_STONE, PTMBlocks.GRAY_END_STONE, PTMBlocks.PINK_END_STONE, PTMBlocks.LIME_END_STONE, PTMBlocks.YELLOW_END_STONE, PTMBlocks.LIGHT_BLUE_END_STONE, PTMBlocks.MAGENTA_END_STONE, PTMBlocks.ORANGE_END_STONE, PTMBlocks.WHITE_END_STONE);
//		newbloctopaint(player, worldIn, pos, Blocks.EMERALD_BLOCK, PTMBlocks.BLACK_EMERALD_BLOCK, PTMBlocks.RED_EMERALD_BLOCK, PTMBlocks.GREEN_EMERALD_BLOCK, PTMBlocks.BROWN_EMERALD_BLOCK, PTMBlocks.BLUE_EMERALD_BLOCK, PTMBlocks.PURPLE_EMERALD_BLOCK, PTMBlocks.CYAN_EMERALD_BLOCK, PTMBlocks.LIGHT_GRAY_EMERALD_BLOCK, PTMBlocks.GRAY_EMERALD_BLOCK, PTMBlocks.PINK_EMERALD_BLOCK, PTMBlocks.LIME_EMERALD_BLOCK, PTMBlocks.YELLOW_EMERALD_BLOCK, PTMBlocks.LIGHT_BLUE_EMERALD_BLOCK, PTMBlocks.MAGENTA_EMERALD_BLOCK, PTMBlocks.ORANGE_EMERALD_BLOCK, PTMBlocks.WHITE_EMERALD_BLOCK);
