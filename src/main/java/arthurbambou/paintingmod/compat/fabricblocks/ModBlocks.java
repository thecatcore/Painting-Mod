...
//        SCUTE_BLOCK = new ColoredBlock("scute_block", com.yanis48.fabriblocks.ModBlocks.SCUTE_BLOCK, FabriBlocks.MOD_ID);
//        BAMBOO_BLOCK = new ColoredBlock("bamboo_block", com.yanis48.fabriblocks.ModBlocks.BAMBOO_BLOCK, FabriBlocks.MOD_ID);
//        SNOW_BRICKS = new ColoredBlock("snow_brick", com.yanis48.fabriblocks.ModBlocks.SNOW_BRICKS, FabriBlocks.MOD_ID);

//        SNOW_BRICK_STAIRS = new ColoredStairs("snow_brick_stairs", com.yanis48.fabriblocks.ModBlocks.SNOW_BRICK_STAIRS, FabriBlocks.MOD_ID);
//
//        SNOW_BRICK_SLAB = new ColoredSlab("snow_brick_slab", com.yanis48.fabriblocks.ModBlocks.SNOW_BRICK_SLAB, FabriBlocks.MOD_ID);
//
//        SNOW_BRICK_WALL = new ColoredWall("snow_brick_wall", com.yanis48.fabriblocks.ModBlocks.SNOW_BRICK_WALL, FabriBlocks.MOD_ID);
        STONE_WALL = new ColoredWall("stone_wall", com.yanis48.fabriblocks.ModBlocks.STONE_WALL, FabriBlocks.MOD_ID);
//        SMOOTH_STONE_WALL = new ColoredWall("smooth_stone_wall", com.yanis48.fabriblocks.ModBlocks.SMOOTH_STONE_WALL, FabriBlocks.MOD_ID);
//        SMOOTH_SANDSTONE_WALL = new ColoredWall("smooth_sandstone_wall", com.yanis48.fabriblocks.ModBlocks.SMOOTH_SANDSTONE_WALL, FabriBlocks.MOD_ID);
//        SMOOTH_RED_SANDSTONE_WALL = new ColoredWall("smooth_red_sandstone_wall", com.yanis48.fabriblocks.ModBlocks.SMOOTH_RED_SANDSTONE_WALL, FabriBlocks.MOD_ID);
        POLISHED_GRANITE_WALL = new ColoredWall("polished_granite_wall", com.yanis48.fabriblocks.ModBlocks.POLISHED_GRANITE_WALL, FabriBlocks.MOD_ID);
        POLISHED_DIORITE_WALL = new ColoredWall("polished_diorite_wall", com.yanis48.fabriblocks.ModBlocks.POLISHED_DIORITE_WALL, FabriBlocks.MOD_ID);
        POLISHED_ANDESITE_WALL = new ColoredWall("polished_andesite_wall", com.yanis48.fabriblocks.ModBlocks.POLISHED_ANDESITE_WALL, FabriBlocks.MOD_ID);
//        QUARTZ_WALL = new ColoredWall("quartz_wall", com.yanis48.fabriblocks.ModBlocks.QUARTZ_WALL, FabriBlocks.MOD_ID);
