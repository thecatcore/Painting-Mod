...
public class ColoredStoneButtonBlock extends StoneButtonBlock implements ColoredBlock {

    private ColoredObject coloredObject;
    private ColoredObject.Color color;

    public ColoredStoneButtonBlock(ColoredObject coloredObject, ColoredObject.Color color) {
