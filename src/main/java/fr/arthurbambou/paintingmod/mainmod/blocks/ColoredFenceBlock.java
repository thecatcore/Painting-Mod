...
public class ColoredFenceBlock extends FenceBlock implements ColoredBlock {

    private ColoredObject coloredObject;
    private ColoredObject.Color color;
    private Identifier identifier;

    public ColoredFenceBlock(ColoredObject coloredObject, ColoredObject.Color color) {
        ...
        Registry.register(Registry.ITEM, new Identifier(coloredObject.modid, color.name().toLowerCase() + "_" + coloredObject.name), new ColoredItemBlock(this, new Item.Settings().group(PaintingMod.MOD_FENCE)));
