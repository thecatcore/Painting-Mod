...
public class ColoredWallBlock extends WallBlock implements ColoredBlock {

    private ColoredObject coloredObject;
    private ColoredObject.Color color;
    private Identifier identifier;

    public ColoredWallBlock(ColoredObject coloredObject, ColoredObject.Color color) {
        ...
        Registry.register(Registry.ITEM, new Identifier(coloredObject.modid, color.name().toLowerCase() + "_" + coloredObject.name), new ColoredItemBlock(this, new Item.Settings().group(PaintingMod.MOD_WALLS)));
